...
def actividades(request, user_id):
    ...
    if request.method == 'GET':
        ...
        actividades_data = [{'id': act.id, 'nombre': act.nombre, 'hora_entrada': act.hora_entrada, 'hora_salida': act.hora_salida, 'personas': act.personas, 'lugar': act.lugar, 'observaciones': act.observaciones} for act in actividades]
