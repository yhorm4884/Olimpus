...
function JoinEmpresa() {
        ...
        if (userId) {
          ...
          axios.get(url, { withCredentials: true })
            .then(response => {
              ...
              const url2 = `http://backend.olimpus.arkania.es/api/empresas/${localStorage.getItem('companyId')}/`;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://backend.olimpus.arkania.es/companies/join/', formData, { withCredentials: true });
