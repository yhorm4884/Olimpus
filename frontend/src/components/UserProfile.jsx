...
const UserProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://backend.olimpus.arkania.es/users/update-profile/", formData);
      ...
      const updatedUserData = await axios.get(`https://backend.olimpus.arkania.es/api/usuarios/${userId}/`, { withCredentials: true });
  ...
  const handleDisableUser = async () => {
    try {
      const response = await axios.post(`https://backend.olimpus.arkania.es/users/deactivate/${userId}/`);
